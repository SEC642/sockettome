...
<html lang="en">
	<head>
		...
		<script type="text/javascript">
			...
			conn.onmessage = function(e) {
				...
				var xss_me = document.getElementById("xss_me");
				xss_me.innerHTML = e.data;
			};
	...
	<body>
		...
		<p>
			I'm thinking of a number between 1 and 100, win adoration from your friends by guessing it.<br />
...
<!--
This is a hint  <img src="x" onerror="alert(1)" />
-->
</html>
